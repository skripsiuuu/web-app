...
@section('title', 'Artikel Gizi & Nutrisi')
...
@section('content')
    ...
    <div class="max-w-7xl mx-auto px-4 mt-8">
        <form action="{{ route('informasi.gizi') }}" method="GET" class="bg-white p-4 rounded-xl shadow-lg flex items-center border border-gray-100">
            <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari artikel gizi & nutrisi..." class="w-full px-4 py-2 text-sm border-none focus:ring-0 outline-none font-medium text-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 py-16">
        ...
        @if($articles->isEmpty())
            <div class="text-center py-10">
                <p class="text-gray-500 font-medium text-lg">Belum ada Artikel Gizi & Nutrisi yang tersedia saat ini.</p>
            </div>
        @else
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-xl transition-shadow duration-300 overflow-hidden group flex flex-col">
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        ...
                        <a href="{{ route('informasi.gizi.detail', $item->slug) }}">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('informasi.gizi.detail', $item->slug) }}" class="inline-block border border-orange-500 text-orange-500 text-xs font-bold px-5 py-2.5 rounded-lg hover:bg-orange-500 hover:text-white transition duration-300">
                                Baca Selengkapnya
                            </a>
                        </div>
                    </div>
